			...
			<div class="container">
				...
				<div class="page-content__container page-content__container--profile">
					...
					<div class="page-content__sidebar">
						...
						<div class="page-content__sidebar-item">
							<div class="page-content-descr-heading">
								<div class="h4">Мои баллы и бонусы</div>
							</div>
                            <div class="page-content__sidebar-stats">
                                <div class="page-content__sidebar-stats-item">
                                    <span class="page-content__sidebar-stats-points">861</span>
                                </div>
                                <div class="page-content__sidebar-stats-item">
                                    <span class="page-content__sidebar-stats-text">+26 за неделю</span>
                                </div>
                                <div class="page-content__sidebar-stats-item">
                                    <a href="javascript:;" class="btn-reset btn btn--noframe btn--green">История начислений</a>
                                </div>
                                <div class="page-content__sidebar-stats-item">
                                    <a href="javascript:;" class="btn-reset btn btn--noframe btn--green">Мои бонусы</a>
                                </div>
                            </div>
						</div>
						<div class="page-content__sidebar-item">
						...
						<div class="page-content__sidebar-item">
							<div class="page-content-descr-heading">
								<div class="h4">Опыт</div>
							</div>
							<div class="page-content__sidebar-stats">
								<div class="page-content__sidebar-stats-item">
									<span class="page-content__sidebar-stats-text">Экодела</span>
									<span class="page-content__sidebar-stats-value">23</span>
								</div>
								<div class="page-content__sidebar-stats-item">
									<span class="page-content__sidebar-stats-text">Экодел</span>
									<span class="page-content__sidebar-stats-value">1 950</span>
								</div>
								<div class="page-content__sidebar-stats-item">
									<span class="page-content__sidebar-stats-text">Верифицированные часы</span>
									<span class="page-content__sidebar-stats-value">1 875</span>
								</div>
							</div>
