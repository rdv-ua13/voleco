        ...
        <div class="page-content">
            <div class="page-content__header">
                <div class="block-mb-md">
                    <div class="details-top-bar">
                        ...
                        <div class="details-top-bar__info">
                            <span class="tag-bar">
                                <span class="tag">
                                    <span
                        ...
                        <div class="details-top-bar__header">
                            <h1 class="h2">«Осознанное добро»: каким должно быть волонтерство и благотворительность</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="page-content__body">
                <div class="media">
                    ...
                    <div class="block-mb-lg">
                        <div class="block-narrow block-narrow--desktop">
                            <div class="page-content__descr">
                                <div class="block-mb-md page-content__descr-item">
                            ...
                            <div class="block-mb-md">
                                <div class="block-header">
                                    <div class="block-header__title">
                                        <div class="block-header__title-text h2">Вам будет интересно</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-list">
