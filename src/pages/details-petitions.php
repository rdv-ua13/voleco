...
<!--<div class="block-mb">
    <div class="container">
        <div class="details-section__petitions">
                ...
                <div class="sidebar__help-count--block-active">
                    <div class="sidebar__help-count">
                        <div class="sidebar__help-count-start">
                            <div class="sidebar__help-count-start-title">Подписали</div>
                            <div class="sidebar__help-count-start-count">110 753 чел.</div>
                        </div>
                        <div class="sidebar__help-count-finish">
                            <div class="sidebar__help-count-start-title">Нужно подписей</div>
                            <div class="sidebar__help-count-start-count">150 000</div>
                        </div>
                    </div>
            ...
            <div class="details-section__projects-list">
                <div class="projects-list-change">
                    <h2 class="projects__list-title">Похожие петиции</h2>
