                        ...
                        <div class="tab-links-slider swiper js-main-section-tabs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="lk-org-events.php#pageContentBody" class="tab-links-slider__link selected">Предстоящие экодела</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="lk-org-events-past.php#pageContentBody" class="tab-links-slider__link">Прошедшие экодела</a>
                                </div>
                            </div>
                        </div>
