						...
						<div class="tab-links-slider swiper js-main-section-tabs">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<a href="lk-vol-events.php#pageContentBody" class="tab-links-slider__link">Предстоящие экодела</a>
								</div>
								<div class="swiper-slide">
									<a href="lk-vol-events-past.php#pageContentBody" class="tab-links-slider__link selected">Прошедшие экодела</a>
								</div>
							</div>
						</div>
					</div>
