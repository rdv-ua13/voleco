                        ...
                        <div class="tab-links-slider swiper js-main-section-tabs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="lk-vol-favorites-org.php#pageContentBody" class="tab-links-slider__link">Организаторы</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="lk-vol-favorites-event.php#pageContentBody" class="tab-links-slider__link">Экодела</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="lk-vol-favorites-project.php#pageContentBody" class="tab-links-slider__link selected">Проекты</a>
                                </div>
                                <div class="swiper-slide">
