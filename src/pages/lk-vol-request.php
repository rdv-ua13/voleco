					...
					<div class="page-content__main page-content__main--full">
                        <div class="block-mb-md">
                            <div class="block-mb-sm">
                                <div class="h2">Заявки на задачи</div>
                            </div>
                        ...
                        <div class="block-mb-lg">
                            <div class="block-mb-sm">
                                <div class="h2">Приглашения на экодела</div>
                            </div>
                            <div class="card-list card-list-column">
                                <a href="javascript:;" class="card card--pa-default">
                                    <span class="card__view">
                                    ...
                                    <span class="card__descr">
                                        ...
                                        <span class="card__contact-btn">
                                            ...
                                            <button class="btn-reset btn btn--fill btn--mini btn--gray">
                                                <span class="btn__text">Отклонить</span>
                                            </button>
                                        </span>
                                    </span>
                                </a>
                            ...
                            <div class="block-mb-md">
                                <div class="block-header">
                                    <div class="block-header__title">
                                        <div class="block-header__title-text h2">Экодела для вас</div>
