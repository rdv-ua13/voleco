            ...
            <div class="container">
                ...
                <div class="page-content__main">
                    <div class="card-list card-list-column">
                        <a href="javascript:;" class="card card--petition">
                            ...
                            <span class="card__descr">
                                    ...
                                    <span class="card__action-data">
                                        <span class="card__action-progress js-progress">
                                            <span class="card__action-progress-bar progress-bar">
                                                ...
                                                <span class="progress-bar__value">
                                                    <span class="semi-bold">110 753</span> из <span class="semi-bold">150 000</span> подписей
                                                </span>
                                        ...
                                        <span class="card__action-progress js-progress">
                                            <span class="card__action-progress-bar progress-bar">
                                                <progress id="" class="visually-hidden progress-bar__indicator" value="33" max="100"></progress>
                                                <span class="progress-bar__value">
                                                    <span class="semi-bold">146 548</span> из <span class="semi-bold">200 000</span> собрано
                                                </span>
                                                <span class="progress-bar__bg">
                                                    <span class="progress-bar__line"></span>
                                                </span>
                                ...
                                <span class="card__contact-btn">
                                    ...
                                    <span class="card__contact-btn-more">
                                        <button class="btn-reset btn btn--fill btn--mini btn--gray mobile-only">
                                            <svg class="icon btn__icon">
                                                <use href="img/sprite.svg#menu-more"></use>
                                            </svg>
                                        </button>
                                        <button class="btn-reset btn btn--fill btn--mini btn--gray desktop-only">
                                            <svg class="icon btn__icon">
