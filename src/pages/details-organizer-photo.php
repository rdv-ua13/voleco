                        ...
                        <div class="block-mb-lg">
                            <div class="block-mb-md">
                                <div class="gallery gallery-photo">
                                    <a class="gallery__item" data-fancybox="gallery-photo" data-src="img/card-photo-events.png">
                                        <picture>
                                            <source srcset="img/card-photo-events.webp" type="image/webp">
                                            <img
                                                    loading="lazy"
                                                    src="img/card-photo-events.png"
                                                    class="image"
                                                    width="260"
                                                    height="190"
                                    ...
                                    <a class="gallery__item" data-fancybox="gallery-photo" data-src="img/card-photo.png">
                                        <picture>
