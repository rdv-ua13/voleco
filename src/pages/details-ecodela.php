                ...
                <div class="block-mb-md">
                    <div class="details-top-bar">
                        ...
                        <div class="details-top-bar__action">
                            <div class="details-top-bar__action-info">
                                <span>134 волонтера</span>
                    ...
                    <div class="page-content__container page-content__container--details">
                        <div class="page-content__content-header">
                            <div class="details-top-bar__header">
                                ...
                                <h1 class="h3">Организация раздельного сбора ТБО в корпусах и общежитиях университета ИТМО</h1>
                            </div>
                                    ...
                                    <span class="card__user-descr">
                                        <span class="card__user-descr-item">
                                            <span class="card__action-item-text">
                                                В рамках проекта
                                                <a class="link link--green" href="javascript:;">Международная программа «Миссия ДОБРО»</a>
                                            </span>
                                        </span>
                                        <span class="card__user-descr-item">
                                            <span class="card__action-data">
                                                <span class="card__action-item">
                                                    ...
                                                    <span class="card__action-item-text">
                                                        ...
                                                        <a class="link link--green" href="javascript:;" style="padding-left: 4px;">Показать на карте</a>
                                                    </span>
                                                </span>
                                                <span class="card__action-item">
                                                    <svg class="icon">
                        ...
                        <div class="block-mb-md">
                            <div class="block-header">
                                <div class="block-header__title">
                                    <div class="block-header__title-text h2">Задачи</div>
...
<?/*<div class="block-mb">
    <div class="container">
        <div class="details-section__ecodela">
            <div class="details-section__header">
                ...
                <div class="details-section__btn">
                    <span class="details-section__btn-text"><span>134 волонтера</span> подали заявку на участие</span>
            ...
            <div class="details-section__discription">
                <div class="details-section__sidebar">
                    <div class="sidebar-header">
                        ...
                        <div class="content-text">
                            <h2 class="content-text__h2">Организация раздельного сбора ТБО в корпусах и общежитиях университета ИТМО</h2>
                        </div>
                        <div class="content-text__geo">
                            <div class="content-text__adress">В рамках проекта <span>Международная программа «Миссия ДОБРО»</span></div>
                            <span class="card__action-data">
                                <span class="card__action-item">
                                    <svg class="icon">
                                        <use href="img/sprite.svg#map-pin"></use>
                    ...
                    <div class="sidebar-img">
                        <img src="img/projects__list-card_3.png" alt="image/png">
                    </div>
                    <div class="sidebar-help">
                        <h2 class="sidebar__help-title">Поддержать проект</h2>
                        <div class="sidebar__help-text">Спасибо, что помогаете в реализации благотворительного проекта!</div>
                ...
                <div class="details-section__content">
                    <div class="details-section__top">
                        ...
                        <div class="content-text__geo">
                            ...
                            <div class="contacts__review">
                                <div class="contacts__review_img">
                                    <div class="contacts__review_img-size">
                                        <img class="review_img" src="img/contacts__review_img.png" alt="logo/img">
                                    </div>
                                    <h3 class="contacts__review_title">Ассоциация волонтерских центров</h3>
                                    <div class="contacts__review_score">
                                        <div class="review__score_count">
                    ...
                    <div class="block-mb-md">
                        <div class="page-content__descr-item">
                            <div class="block-mb-sm page-content-descr-heading">
                                <div class="h4">Описание</div>
                            </div>
                            <div class="page-content__descr-content">
                                <div class="page-content__spoiler js-spoiler" data-collapsed-height="88">
                    ...
                    <div class="content-contacts">
                        <div class="content-discription__title">Контакты</div>
                        <div class="content-contacts__manager">
                            <div class="content-contacts__manager-all">
                                <div class="manager__info_photo">
                                    <img class="info_photo" src="img/manager__info_photo.png" alt="photo manager">
                                </div>
                    ...
                    <div class="content-social">
                        <div class="content-discription__title">Мы в соцсетях</div>
                    ...
                    <div class="content-materials">
                        <div class="content-discription__title">Материалы</div>
                        <div class="materials_file">
                            ...
                            <div class="materials_file-dock">
                                ...
                                <div class="materials_file-text">
                                    <div class="materials_file-title">Печерень участников благотворительного мероприятия 2021 г.</div>
        ...
        <div class="ecodela-tasks">
            <h2 class="ecodela-tasks-title">Задачи <span>11</span></h2>
            <div class="ecodela-tasks__wrapper">
                <div class="ecodela-tasks__list">
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Помощь в доставке продуктов и лекарств</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count">Набрано <span class="color__list_help-result">105</span> из 500</div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help active">
                        <div class="ecodela-tasks__list-help-title">Помощь в медицинских организациях</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count">Набрано <span class="color__list_help-result">211</span> из 770</div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Оказание психологической помощи</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count">Набрано <span class="color__list_help-result">15</span> из 20</div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Автоволонтерство</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count ecodela-tasks__list-help-rezult-count--red">
                                Набор завершен
                            </div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Помощь в колл-центрах</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count">Набор не ограничен</div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Помощь в доставке продуктов и лекарств</div>
                        <div class="ecodela-tasks__list-help-rezult">
                            <div class="ecodela-tasks__list-help-rezult-count">Набрано 105 из 500</div>
                        </div>
                    </div>
                    <div class="ecodela-tasks__list-help">
                        <div class="ecodela-tasks__list-help-title">Помощь в медицинских организациях</div>
                ...
                <div class="ecodela-tasks__detail">
                    <div class="ecodela-tasks__detail-top">
                        <div class="ecodela-tasks__detail-top-title">Помощь в медицинских организациях (Для волонтеров
                            с медицинским образованием и студентов-медиков)
                        </div>
                        <div class="ecodela-tasks__detail-top-btn">
                    ...
                    <div class="block-mb-md">
                        <div class="page-content__descr-item">
                            <div class="block-mb-sm page-content-descr-heading">
                                <div class="ecodela-tasks__detail-text-title">Задачи</div>
                            </div>
                            <div class="page-content__descr-content">
                                <div class="page-content__spoiler js-spoiler" data-collapsed-height="88">
                                    <div class="page-content__spoiler-text">
                    ...
                    <div class="ecodela-tasks__detail-date">
                        <div class="ecodela-tasks__detail-date-title">Занятость</div>
                        <div class="ecodela-tasks__detail-date-number">29 сентября 2020 — 25 февраля 2022, 08:00 -
                            20:00
                        </div>
                    </div>
                    <div class="ecodela-tasks__detail-conditions">
                        <div class="ecodela-tasks__detail-text-title">Предлагаемые условия</div>
                        <div class="ecodela-tasks__detail-text-text">Открыт набор в волонтеры на Special Olympics World
                            Games Berlin 2023 в рамках Программы мобильности. Кандидаты, успешно прошедшие отбор по
                            Программе, будут обеспечены проживанием и проездом к месту проведения события и обратно.
                            Всемирная Специальная Олимпиада — самое масштабное событие в мире инклюзивного спорта —
                            проводится каждые четыре года с конца 60-х годов прошлого века. 7 000 атлетов,
                            представляющих 180 различных наций, выступят в 25 спортивных дисциплинах.
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-list">
                            <a href="javascript:;" class="card">
                                <span class="card__view">
                                    <picture>
                                        <img
                                                loading="lazy"
                                                src="img/projects__list-card_1.png"
                                                class="image"
                                                width="270"
                                                height="180"
                                                alt="Фото карточки"
                            ...
                            <a href="javascript:;" class="card">
                                ...
                                <span class="tag__content-text" style="color: var(--warning3-color);">Животные</span>
                                        ...
                                        <span class="card__title">XI Международный форум «Арктика: настоящее и будущее»</span>
                                        <span class="card__action">
                                            <span class="card__action-data">
                                                <span class="card__action-item">
                                                    <svg class="icon">
